...
compile_readable_js() {
    "$UGLIFYJS_BINARY" pineapple/js/pineapple.js --beautify --no-annotations --source-map --verbose --comments '/https://github.com/justintime50/pineapple/' --output pineapple/dist/js/pineapple.js
    echo "Readable JS step complete!"
}

compile_minified_js() {
    "$UGLIFYJS_BINARY" pineapple/js/pineapple.js --source-map --verbose --comments '/https://github.com/justintime50/pineapple/' --output pineapple/dist/js/pineapple.min.js
